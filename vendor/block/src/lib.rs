...
// Patched: an uninhabited `enum Class {}` as an extern static is being phased out by rustc
// (rust-lang/rust#74840). An opaque zero-sized struct has the same meaning. Bare `extern`
// also became `extern "C"` (same ABI, no deprecation warning).
#[repr(C)]
struct Class {
    _private: [u8; 0],
}
